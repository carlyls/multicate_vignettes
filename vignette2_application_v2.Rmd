...
table <- data.frame(Variables = colnames(rhc_clean_table),
                    ...
                    Description = c('[treatment] RHC was administered within 24 hours of admission (Yes = 1, No = 0)',
                                    '[studies] Arbitrary created variable referring to the hospitals/centers that RHC was administered at',
...
### 5-1) Visualization of study-specific
...
### 5-2) Visualization of study-indicator

```{r}
plot(cate_mod2)
```
```{r}
plot_vteffect(cate_mod2, covariate_name = "aps1")
```

...
![A two-step approach for using the `multicate` package.](Images/TwoStep_Update.png){width="1000px" height="300px"}
...
CATE prediction leverages prediction interval techniques used in two-stage meta-analysis. Briefly:
...
For additional details and parameter options, refer to the package documentation. [^13] [^14]

[^13]: dbarts CRAN manual <https://cran.r-project.org/web/packages/dbarts/index.html>

[^14]: grf CRAN manual <https://cran.r-project.org/web/packages/grf/index.html>
